...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  new G4PVPlacement(nullptr, {}, logicLXe, "LXe", logicWorld, false, 0, checkOverlaps);
  ...
  new G4PVPlacement(nullptr, {0,0, 0.5*geom.lxe_height + geom.gxe_height + 0.5*geom.pmt_thick}, logicTopPMT, "TopPMT", logicWorld, false, 0, checkOverlaps);
  ...
  new G4PVPlacement(nullptr, {0,0, -(0.5*geom.lxe_height + 0.5*geom.pmt_thick)}, logicBotPMT, "BottomPMT", logicWorld, false, 0, checkOverlaps);
